...
#     def attack(self):
#         print(f"The monster have attacked for {self.energy}")

#     def move(self):
#         print("The monster have awaken")


# monster = Monster(45, 60)
# monster.attack()


# class Shark(Monster):
#     def __init__(self, speed, health, energy):
#         # Monster.__init__(self, health, energy) # One olde way to inheritance attribute
#         # New way to inheritance attribute from the parent class
#         super().__init__(health, energy)
#         self.speed = speed

#     def bite(self):
#         print(f"The shark is moving fast {self.speed}")


# # shark = Shark(10, 30, 30)
# # shark.bite()
# # shark.move()
# # shark.attack()
...
#     def __init__(self, poisons_damage, health, energy):
#         self.poisons_damage = poisons_damage
#         super().__init__(health, energy)

#     def attack(self):
#         print(f"Scorpion has bit you fo {self.poisons_damage}")


# scorpion = Scorpion(20, 20, 20)
# scorpion.attack()
